function m = model_create(cls, note, interval, sbin, featureSet)
...
m.year          = 2012;   % dataset year (PASCAL specific)
...
m.interval      = interval;           % # levels in each feature pyramid octave
m.sbin          = sbin;               % pixel size of the HOG cells
...
m.features      = featureSet;         % info about image features
m.features.bias = featureSet.bias_feature; % feature value for bias/offset 
                                              % parameters
