function [m, symbol, filterind] = model_add_terminal(m, featurename, varargin)
...
valid_opts = {'w', 'blocklabel', 'flip', 'mirror_terminal','fname'};
...
if opts.isKey('mirror_terminal')
  ...
  opts('w')          = flipfeat(model_get_block(m, m.filters(fi), featurename), featurename);
