...
options.bFlipPos = 1;
options.imSubDir = '/images'; % sub directory in each folder in options.lsvmNegFolders that contains images, if you use my provided negative data, it should be '/images'
